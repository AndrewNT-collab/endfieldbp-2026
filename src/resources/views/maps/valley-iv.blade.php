...
<main style="padding:36px; max-width:1300px; margin:auto;">
    ...
    <h1 style="margin:0 0 8px; font-size:42px;">Valley IV Map</h1>
    <p style="margin:0 0 24px; color:#b0b0b0;">Select a location inside Valley IV.</p>
