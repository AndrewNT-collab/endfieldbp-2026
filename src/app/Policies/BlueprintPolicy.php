...
class BlueprintPolicy
{
    ...
    {
        return $user->can('view_any_blueprint');
    }
    ...
    {
        return $user->can('view_blueprint');
    }
    ...
    {
        return $user->can('create_blueprint');
    }
    ...
    {
        return $user->can('update_blueprint');
    }
    ...
    {
        return $user->can('delete_blueprint');
    }
    ...
    {
        return $user->can('delete_any_blueprint');
    }
     ...
     */
    public function replicate(User $user, Blueprint $blueprint): bool
    {
